<template>
	<div style="margin-top: 100px;">
		<PageHeader v-if="student_user.length!=0" title="发布商品" />
		...
		<div v-else style="margin: 0 auto; max-width: 900px; width: 100%; padding: 0 16px;">
			<el-form label-width="80px" size="medium" :model="form" ref="form">
				...
				<el-form-item label="商品名" prop="gname" :rules="[
					...
					<el-form-item label="商品分类" prop="gcategory" :rules="[
													  { required: true, message: '请选择商品分类'}
													  ]">
						<el-select v-model="form.gcategory" placeholder="请选择商品分类" style="width: 100%;">
							<el-option label="教辅教材" value="教材"></el-option>
							<el-option label="电子产品" value="电子"></el-option>
							<el-option label="生活用品" value="生活"></el-option>
							<el-option label="服饰鞋包" value="服饰"></el-option>
							<el-option label="运动户外" value="运动"></el-option>
							<el-option label="其他好物" value="其他"></el-option>
						</el-select>
					</el-form-item>
...
<script>
	...
	import { uploadImg } from '/src/utils/upload.js'
	export default {
		components: {
			PageHeader,
			EmptyState,
