<template>
	<div style="padding-top: 60px;">
		<PageHeader title="确认订单" @back="goBack" backLabel="" />
		<span style="color: #ff6700;margin: 0 auto; max-width: 1200px; width: 100%; padding: 0 16px;height: 50px;display: flex;align-items: center;justify-content: center;">
			当前支付订单
		</span>
		<div style="height: 1px; background: #ddd;width: 1200px;margin: 0 auto;" />
		<div style="margin: 0 auto; max-width: 1200px; width: 100%; padding: 0 16px;padding-top: 12px;display: flex;">
		...
		<div style="margin: 0 auto; max-width: 1200px; width: 100%; padding: 0 16px;margin-top: 14px;margin-bottom: 100px;">
