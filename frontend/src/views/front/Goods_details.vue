<template>
	<div style="padding-top: 60px;">
		<PageHeader title="商品详情" @back="goBack" backLabel="">
		...
		<div class="detail-layout" style="margin: 0 auto; max-width: 1200px; width: 100%; padding: 12px 16px 0;">
			<el-image :src="goods_list.gphoto" :preview-src-list="[goods_list.gphoto]"
				style="width: 400px; max-width: 100%; height: 400px;border-radius: 7px;">
				<div slot="error">
					<img src="../../assets/none.jpg" style="width: 100%;height:400px;border-radius: 7px;" />
				</div>
			</el-image>
			<el-descriptions style="flex: 1; min-width: 0; margin-left: 4%;" size="medium" class="margin-top"
		...
		<div style="margin: 0 auto; max-width: 1200px; width: 100%;margin-top: 14px;">
			...
			<div style="padding-top: 110px;padding-bottom: 30px;">
				...
				<el-form :model="dataForm" status-icon :rules="rules" ref="dataForm">
					<el-form-item prop="comment">
						<el-input size="medium" v-model="dataForm.comment" type="textarea" style="width: 100%" :rows="4" maxlength="255"
				...
				<div style="text-align: center;padding-right: 0;padding-top: 50px;">
...
<style>
	...
	@media (max-width: 768px) {
		...
		.detail-layout .el-image {
			width: 100% !important;
			height: 300px !important;
		}
		.detail-layout .el-descriptions {
