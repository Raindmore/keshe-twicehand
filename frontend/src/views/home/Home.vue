	...
	<div style="color: #666;font-size: 14px;">
		...
		<el-card>
			<div style="display: flex; align-items: center; gap: 16px;">
				<el-avatar :size="48" style="background: #5aa9ad; font-size: 20px; color: #fff;">
					{{ user.ausername ? user.ausername.charAt(0) : 'A' }}
				</el-avatar>
				<div>
					<div style="font-size: 18px; font-weight: 600; color: #333;">
						欢迎回来，{{ user.ausername }}
					</div>
					<div style="font-size: 13px; color: #949494; margin-top: 4px;">
						高校二手交易管理后台
					</div>
				</div>
			</div>
...
@media (max-width: 768px) {
	.el-col[span="6"] { flex: 0 0 50%; max-width: 50%; margin-bottom: 10px; }
	.el-col[span="12"] { flex: 0 0 100%; max-width: 100%; }
}
</style>
