		...
		<div class="goods-section">
			<div class="goods-section-inner">
				<div class="goods-header">
					<span v-if="total===0">
						<el-empty :image-size="200" description="暂无相关商品"></el-empty>
					</span>
					<span v-else class="goods-count">
						共 <b>{{total}}</b> 个商品
				...
				<el-row v-if="total>0" :gutter="16" class="goods-grid">
					<el-col
						...
						class="goods-col"
					>
						<div class="goods-card" @click="goods_details(goods_list.gid)">
							<div class="goods-card-img">
								<el-image :src="goods_list.gphoto" fit="cover" class="goods-img">
									<div slot="error" class="goods-img-fallback">
										<img src="../../assets/none.jpg" />
									</div>
								</el-image>
							</div>
							<div class="goods-card-body">
								<h3 class="goods-name">{{goods_list.gname | ellipsis}}</h3>
								...
								<div class="goods-price-row">
									<span class="goods-price">{{goods_list.gsellprice}}</span>
								</div>
							</div>
						</div>
					</el-col>
...
.goods-card:hover {
	...
	box-shadow: 0 20px 48px rgba(102,126,234,0.22);
...
.goods-card-img {
	...
	padding-top: 100%;
	overflow: hidden;
	background: linear-gradient(135deg, #f5f0ff, #e8f0fe);
}
